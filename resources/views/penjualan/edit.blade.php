  ...
  <div class="modal" id="modal_selesai" role="dialog" data-backdrop="">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        {!! Form::open(['url' => route('penjualan.proses_edit_penjualan',$penjualan->id),'method' => 'post', 'class'=>'form-horizontal']) !!}
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h2 class="panel-title">Edit Penjualan <b> {{$penjualan->no_faktur}}</b></h2> 
				</div>
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-md-8"> 
      					    {!! Form::open(['url' => route('penjualan.proses_tambah_edit_tbs_penjualan', $penjualan->id),'method' => 'post', 'class'=>'form-horizontal']) !!}
						...
						<div class="col-md-4">
							...
							<!-- TOMBOL BATAL -->
							{!! Form::open(['url' => route('penjualan.proses_hapus_semua_edit_tbs_penjualan',$penjualan->id),'method' => 'post', 'class' => 'form-group js-confirm', 'data-confirm' => 'Apakah Anda Ingin Membatalkan Item masuk ?']) !!} 							       		
						    <!--- TOMBOL SELESAI -->
